...
| Widget | Screenshot |
|---|---|
| Drum Kit | <img width="1891" height="887" alt="Снимок экрана 2026-07-03 180040" src="https://github.com/user-attachments/assets/08a8c6aa-b8d2-4a2a-a2ef-24c235d6e0e1" /> |
| Vertical Slider | <img width="1915" height="906" alt="Снимок экрана 2026-07-03 180015" src="https://github.com/user-attachments/assets/a2ec99f4-47f5-4459-9e22-f8b6adf1d535" /> |


3. Done 03.07.2026 / deadline 06.07.2026
4. Score: 130 / 130
...
- [x] Melody recording and playback (+10)
- [x] Floating musical notes animation (+10)
- [x] Demo / custom theme toggle that persists across reloads (+10)

---

### 🟢 Widget 2: Vertical Slider
**Score: 65 / 65**
