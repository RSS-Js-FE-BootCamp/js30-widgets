links: [Drum-kit](https://deploy-preview-112--js-30-widget-gallery.netlify.app/students/daryakarni/drum-kit/)
       [Clock-JS](https://deploy-preview-112--js-30-widget-gallery.netlify.app/students/daryakarni/js-clock/)
1. Task: [JS30-Widgets](https://github.com/rolling-scopes-school/tasks/blob/master/stage0.5%20Bootcamp/tasks/js30/js30.md)
2. Screenshots:
| JS Clock |  | <img width="1916" height="1007" alt="image" src="https://github.com/user-attachments/assets/442574ab-be18-4cad-b225-0e63f210085e" />
| Drum Kit |  |<img width="1902" height="1017" alt="image" src="https://github.com/user-attachments/assets/b8094058-468f-436b-b609-d1fe0eb3473d" />
...
- [ ] A "do nothing for 2 minutes" relaxation mode with a timer (+10)
...
**Stage 3 - Optional improvements (0/30)**
- [ ] Floating notes that spawn on click (+10)
- [ ] Material-style ripple (+10)
- [ ] Dark / light theme toggle that persists across reloads (+10)
---
